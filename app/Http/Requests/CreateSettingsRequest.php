...
class CreateSettingsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'active' => 'required',
            'privacy_policy_en' => 'required|max:10000',
            'privacy_policy_ar' => 'required|max:10000',
            'Terms_and_Conditions_en' => 'required|max:10000',
            'Terms_and_Conditions_ar' => 'required|max:10000',
