...
class updateSettingsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'content_video_en' => 'required|max:2000',
            'content_video_ar' => 'required|max:2000',
            'title_gallary_en' => 'required|max:255',
            'title_gallary_ar' => 'required|max:255',
            'content_gallary_en' => 'required|max:2000',
            'content_gallary_ar' => 'required|max:2000',
            'active' => 'required',
            ...
            'logo_header' => 'nullable|image|mimes:png,jpg,jpeg,svg,gif',
            'logo_footer' => 'nullable|image|mimes:png,jpg,jpeg,svg,gif',
        ];
    }
