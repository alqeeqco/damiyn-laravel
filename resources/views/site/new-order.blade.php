                    ...
                    <div class="col-md-7">
                        <div class="input-group mb-3 mt-3 direction-ltr">
                            <button class="input-group-text" id="basic-addon1"><img
                                    src="{{ asset('webassets/images/blog/search-normal.svg') }}" alt=""></button>
                            <input type="text" name="searchbyOrderNumber" id="searchbyOrderNumber"  class="form-control" placeholder="بحث برقم الطلب"  aria-describedby="basic-addon1" >
                        </div>
                    </div>
