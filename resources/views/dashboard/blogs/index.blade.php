        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-info"><a  href="{{ route('admin.blogs.create') }}">{{ __('admin.add blogs') }}</a></button>
                </div>
                <div class="card-body">
                        ...
                        <table class="table border-top-0  table-bordered text-nowrap border-bottom" id="asasd"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($info->active == 1)
                                        <a href="{{ route('admin.blogs.toggle_active',$info->id) }}" class="btn text-white"
                                    ...
                                    @else
                                        <a href="{{ route('admin.blogs.toggle_active',$info->id) }}" class="btn text-white btn-warning"
