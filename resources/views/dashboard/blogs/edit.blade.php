                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="content_en" id="content_en" cols="10" rows="2"  class="form-control">{{ old('content_en',$data['content_en']) }}</textarea>
                            @error('content_en')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="content_ar" id="content_ar" cols="10" rows="2"  class="form-control">{{ old('content_ar',$data['content_ar']) }}</textarea>
                            @error('content_ar')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="col-sm-12 col-md-8 mg-t-10 mg-md-t-0">
                            <input type="file" name="image" class="dropify" data-default-file="{{ asset('uploads/Blog/'.$data['image'] ) }}" data-height="200">
                            @error('image')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
