        ...
        <script>
            ...
            new Chart(ctx8, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [{{ \App\Models\Order::where('created_at', '>=', \Carbon\Carbon::now()->subWeek())->where('Order_status', '2')->count() }},
                            {{ \App\Models\Order::where('created_at', '>=', \Carbon\Carbon::now()->subWeek())->where('Order_status', '1')->count() }},
                            {{ \App\Models\Order::where('created_at', '>=', \Carbon\Carbon::now()->subWeek())->where('Order_status', '0')->count() }}
                        ],
                        borderColor: '#f7557a ',
                        borderWidth: 1,
                        fill: false
