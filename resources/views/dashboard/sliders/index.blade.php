        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-success"><a  href="{{ route('admin.slider.create') }}">{{ __('admin.add slider') }}</a></button>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline" action="{{ route('admin.slider.delete',$info->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
