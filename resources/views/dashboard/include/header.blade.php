    ...
    <div class="container-fluid main-container ">
            ...
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    @foreach (\App\Models\Setting::limit(1)->get() as $logo)
                        ...
                        <img src="{{ asset('uploads/settings/' . $logo->logo_footer) }}" class="dark-logo-1"
                            alt="logo">
                    @endforeach
                </a>
            </div>
        ...
        <div class="main-header-right">
            ...
            <div class="mb-0 navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">
                <div class="{{ app()->getLocale() == 'en' ? 'collapse' : '' }} navbar-collapse"
                    ...
                    <ul class="nav nav-item  navbar-nav-right ms-auto">
                                    ...
                                    <div class="dropdown  nav-item countries">
                                        ...
                                        <a href="javascript:void(0);" class="d-flex  nav-item nav-link country-flag1"
                                            ...
                                            <span class="avatar country-Flag me-0 align-self-center bg-transparent">
                                                <svg xmlns="{{ asset('adminassets/img/' . $properties['flag']) }}"
                                                    viewBox="0 0 512 512" class="flag-icon1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow">
                                            ...
                                            @if ($localeCode == 'en')
                                                <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }} "
                                                    hreflang="{{ $localeCode }}" class="dropdown-item d-flex ">
                                                    <span class="avatar me-1 align-self-center bg-transparent"><img
                                                            src="{{ asset('adminassets/img/uk.png') }}"
                                                            alt="img"></span>
                                                    <div class="d-flex">
                                            ...
                                            @else
                                                <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                                    hreflang="{{ $localeCode }}" class="dropdown-item d-flex ">
                                                    <span class="avatar me-1 align-self-center bg-transparent"><img
                                                            src="{{ asset('adminassets/img/sa.png') }}"
                                                            alt="img"></span>
                                                    <div class="d-flex">
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.resetPassword') }}"><i
                                        class="bx bx-user-circle"></i>{{ __('Reset Password') }}</a>
