        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    <img src="{{ asset('adminassets/img/brand/logo.png') }}" class="logo-1" alt="logo">
                    <img src="{{ asset('adminassets/img/brand/logo-white.png') }}" class="dark-logo-1" alt="logo">
                </a>
            </div>
                ...
                <div class="{{ app()->getLocale() == 'en' ? 'collapse' :''}} navbar-collapse" id="navbarSupportedContent-4">
                    <ul class="nav nav-item  navbar-nav-right ms-auto">
                            ...
                            <div class="dropdown  nav-item countries">
                                ...
                                <div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow">
                                     ...
                                     <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }} " hreflang="{{ $localeCode }}" class="dropdown-item d-flex ">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img src="{{ asset('adminassets/img/uk.png') }}" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    @else
                                    <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" hreflang="{{ $localeCode }}" class="dropdown-item d-flex ">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img src="{{ asset('adminassets/img/sa.png') }}" alt="img"></span>
                                        <div class="d-flex">
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href=""><img alt="" src="{{ asset('adminassets/img/users/6.jpg') }}"></a>
                            <div class="dropdown-menu">
                                <div class="main-header-profile bg-primary p-3">
                                    <div class="d-flex wd-100p">
                                        <div class="main-img-user"><img alt="" src="{{ asset('adminassets/img/users/6.jpg') }}" class=""></div>
                                        <div class="ms-3 my-auto">
                                            <h6>{{Auth::user()->name}}</h6><span>{{Auth::user()->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                <a class="dropdown-item" href="{{ route('admin.resetPassword') }}"><i class="bx bx-user-circle"></i>Reset Password</a>
                                <a class="dropdown-item" href=" {{ route('admin.profile.edit') }}"><i class="bx bx-cog"></i> Edit Profile</a>
                                <a class="dropdown-item" href="{{ route('admin.settings.index') }}"><i class="bx bx-slider-alt"></i> Account Settings</a>
                                <form action="{{ route('logout') }}" method="post" class="d-flex">
                                @csrf
                                    @method('delete')
                                <button class="dropdown-item" style="border: 0; outline: 0;" type="submit"><i class="bx bx-log-out"></i> Sign Out</button>
                                </form>
                            </div>
                        </li>
                    </ul>
